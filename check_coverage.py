...
def check_lint():
    ...
    job = subprocess.getoutput("go test dealls-prototype/... -v -cover | grep 'coverage' | grep -v 'ok' | awk '{print $2}' ")
    job_count = subprocess.getoutput("go test dealls-prototype/... -v -cover | grep 'coverage' | grep -v 'ok' | wc -l")
    job_run = subprocess.getoutput("go test dealls-prototype/... -v -cover | grep 'RUN' | wc -l")
    job_pass = subprocess.getoutput("go test dealls-prototype/... -v -cover | grep 'PASS:' | wc -l")
